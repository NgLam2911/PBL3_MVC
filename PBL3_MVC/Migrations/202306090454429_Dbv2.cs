namespace PBL3_MVC.Migrations
{
    ...
    public partial class Dbv2 : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        Departure_LocationID = c.Int(nullable: false),
                        Destination_LocationID = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.RouteID)
                .ForeignKey("dbo.Location", t => t.Departure_LocationID)
                .ForeignKey("dbo.Location", t => t.Destination_LocationID)
                .Index(t => t.Departure_LocationID)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Route", "Destination_LocationID", "dbo.Location");
            DropForeignKey("dbo.Route", "Departure_LocationID", "dbo.Location");
            ...
            DropIndex("dbo.Route", new[] { "Destination_LocationID" });
            DropIndex("dbo.Route", new[] { "Departure_LocationID" });
