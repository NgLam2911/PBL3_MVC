...
namespace PBL3_MVC.Areas.Admin.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AccountID,Name,Email")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AccountID,Name,Email")] Customer customer)
        {
            if (ModelState.IsValid)
            {
